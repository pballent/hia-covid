...
- To complete this analysis, I ran all combinations of my selected variables (64 separate models) on each 1-month tranche of data in my dataset, starting in the April-May time frame, and ending with the last complete month of data at the time of analysis (November-December). 
...
- The models with more variables achieved higher adjusted R squared measures, as expected, but the graph of all of these models showed an interesting trend. 
